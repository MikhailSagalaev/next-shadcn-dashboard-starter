      ...
      <CardContent className='space-y-4'>
          ...
          <>
            ...
            <div className='flex items-start justify-between gap-4 rounded-lg border p-4'>
              <div className='space-y-1'>
                ...
                <p className='text-muted-foreground text-sm'>
                  Новый клиент сразу виден в ветке пригласившего со статусом
                  ожидания. Реферальные выплаты начнут учитываться после
        ...
        <div className='text-muted-foreground rounded-md border-l-2 border-amber-300 bg-amber-50/50 p-3 text-xs dark:border-amber-700 dark:bg-amber-950/20'>
          ...
          <ul className='mt-1 list-inside list-disc space-y-0.5'>
            ...
            <li>
              Приветственные бонусы начисляются автоматически из основных
              настроек проекта — отдельная нода workflow не нужна
            </li>
          </ul>
        </div>
      </CardContent>
