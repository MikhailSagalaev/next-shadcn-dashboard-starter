...
export default function SettingsPage() {
  ...
  const handleSaveSettings = async () => {
    if (settings.personal.email && !emailRegex.test(settings.personal.email)) {
    ...
    if (
      ...
      !emailRegex.test(settings.notifications.notificationEmail)
    ) {
      toast.error('Введите корректный email для уведомлений');
      return;
    }

    if (
      settings.personal.phone &&
      settings.personal.phone.trim().length > 0 &&
      !phoneRegex.test(settings.personal.phone)
    ) {
                ...
                <div className='space-y-4'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className='flex flex-wrap items-center justify-between gap-2'>
                      <p className='text-muted-foreground text-sm'>
                        Пароль должен содержать буквы и цифры, минимум 8
                        символов
                      </p>
                      <Button
                        variant='outline'
            ...
            <Card>
              ...
              <CardContent className='space-y-6'>
                <div className='space-y-4'>
                  ...
                  <div className='flex flex-wrap items-center justify-between gap-2'>
                    <p className='text-muted-foreground text-sm'>
                      Отправьте тестовое письмо, чтобы убедиться, что адрес
                      указан верно.
                    </p>
                    <Button
                      variant='outline'
