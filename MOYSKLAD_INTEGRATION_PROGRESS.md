...
- [ ] Форма активации интеграции
- [ ] Генерация credentials (Auth Token, Base URL)
- [ ] Регенерация токена
- [ ] Отображение статуса интеграции

#### UI для мониторинга API логов
- [ ] Компонент истории API запросов
- [ ] Фильтрация логов
