## [2025-09-29] - Плашка регистрации для неавторизованных пользователей + Автоматический пересчет бонусов
...
- **Новая версия виджета**: Обновлена до версии 1.3.0 (v8) с плашкой регистрации и автоматическим пересчетом бонусов
...
- Обновлена версия виджета с v7 до v8 для применения плашки регистрации и полной отмены бонусов
