## [2025-10-01] - Упрощение системы шаблонов и оптимизация
...
### 🗑️ Удалено
- Marketplace система шаблонов с покупками/продажами
- A/B тестирование потоков ботов
- Отдельная аналитика по ботам
