## [2025-09-23] - Масштабные улучшения UI/UX и исправления критических ошибок
### 🎯 Добавлено
...
- **КРИТИЧНО**: Исправлена логика списания бонусов при покупке - теперь ошибки не блокируют начисление
...
- Убрана ссылка на удаленную опцию `SPEND_ONLY` из webhook логики
- Улучшена навигация с единообразным размещением кнопок "Назад"

### 🗑️ Удалено
- Вкладка "Настройки" из интеграции (нерабочий функционал)
- Опция "Только списывать бонусы" из выпадающего списка поведения
