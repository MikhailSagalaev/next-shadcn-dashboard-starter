...
- [x] 1. Add OperationMode to database schema
...
- [x] 2. Update user registration logic



  - [x] 2.1 Update `src/lib/services/user.service.ts`
...
- [x] 3. Update webhook handler



  - [x] 3.1 Update webhook handler for spend_bonuses action
...
- [x] 5. Update bot service initialization



  - [x] 5.1 Update `src/lib/services/bot-manager.ts` or equivalent
...
- [x] 6. Create UI components for operation mode selection


  - [x] 6.1 Create `src/features/projects/components/operation-mode-selector.tsx`
  ...
  - [x] 6.2 Create `src/features/projects/components/operation-mode-confirm-dialog.tsx`
...
- [x] 7. Integrate operation mode into project settings



  - [x] 7.1 Update `src/features/projects/components/project-settings-view.tsx`
  ...
  - [x] 7.2 Update project API endpoint to handle operationMode
...
- [x] 8. Update user profile display


  - [x] 8.1 Update user profile components
